...
<body>
    ...
    <?php 
        if (isset($_POST["user"])) {
            ...
            $consulta="alter table usuarios (nombre, apellidos, dni, email, telefono, direccion, password) values ('$user', '$apellidos', '$dni', '$mail', $telefono, '$direccion', md5('$password'));";
...
$query="select * from ".$_GET['tabla']." where ".$_GET['campo']."='".$_GET['id']."'";
        echo ($query);
